...
refA <- read.csv("~/RSV/git/RSV Genetic Diversity/Refseq_rsvA.csv") #Metadata for reference strains
refB <- read.csv("~/RSV/git/RSV Genetic Diversity/Refseq_rsvB.csv")
...
rsvA_ref <- full_join(rsvA, refA, by = join_by(Accession, Organism_Name, Organization, Org_location, Isolate,
                                               Molecule_type, Length, Nuc_Completeness, Country, Collection_Date, GenBank_Title))
rsvB_ref <- full_join(rsvB, refB, by = join_by(Accession, Organism_Name, Organization, Org_location, Isolate,
                                               Molecule_type, Length, Nuc_Completeness, Country, Collection_Date, GenBank_Title))
...
df_label_A$tip.label[2] <- "NC_038235_A_RefSeq" #Reference genome
...
df_label_B$tip.label[24] <- "NC_001781_B_RefSeq"
...
#ggsave(filename = "~/RSV/git/RSV Genetic Diversity/Treefiles/tree_rsvB_annotated.pdf", width = 300, height = 300, units = "cm", limitsize = FALSE)
